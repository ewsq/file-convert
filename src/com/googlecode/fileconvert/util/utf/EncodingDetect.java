...
public class EncodingDetect {
    ...
    public static void main(String[] args) {
        System.out.println(EncodingDetect.detect("F:\\test\\PublicMethod\\src\\com\\publicmetod\\func\\StrHex.java"));
    ...
    public static String detect(String path) {
        ...
        try {
            ...
            if (head[0] == -17 && head[1] == -69 && head[2] == -65) { //带BOM
                ...
                fileCode = BytesEncodingDetect.javaname[s.detectEncoding(new File(path))];
            }
